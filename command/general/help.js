...
module.exports = {
    ...
    async exec(msg, sock, args) {
        if (args[0]) {
            ...
            str += `Untuk bantuan Ketikkan ${prefix}help diikuti perintah/command , e.g. ${prefix}help wiki`;
            await sock.sendMessage(msg.from, {
                text: str,
                footer: "Ayraku My PrivateBot • TammyArtha",
                templateButtons: [

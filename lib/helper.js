...
function serialize(msg, sock) {
    ...
    if (msg.message) {
        ...
        msg.body = msg.message?.conversation || msg.message?.[msg.type]?.text || msg.message?.[msg.type]?.caption || (msg.type === "listResponseMessage") && msg.message?.[msg.type]?.singleSelectReply?.selectedRowId
            || (msg.type === "buttonsResponseMessage" && msg.message?.[msg.type]?.selectedButtonId?.includes("Ayraku")) && msg.message?.[msg.type]?.selectedButtonId || (msg.type === "templateButtonReplyMessage") && msg.message?.[msg.type]?.selectedId || '';
